...
svm_input_dir="svm_rank/input_files_dib_gibbs" #path to store generated svm input
#input
topic_file="data/topics-with-intruder_dib_gibbs.txt"
intruder_file="data/intruder.txt"
ref_corpus_dir="../../clean_data/ref_corpus"
#output
wordcount_file="wordcount/wc-wi_dib_gibbs.txt"
wi_file="results/topics-wi_dib_gibbs.txt"
